...
//
// Run with:
//   node --experimental-test-module-mocks --test out/test/operations/terminate_process_tree.test.js
...
const { terminateProcessTree } = await import('../../src/operations/external_tools/run_external_tool.js');
