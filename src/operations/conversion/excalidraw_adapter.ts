...
/**
 * The official exportToSvg() entry bundled by webview/excalidraw/vite.config.ts.
 * The build layout differs between the extension (`out/...`) and the test build
 * (`out/src/...`), so search upward from this module until the bundle is found.
 */
