...
- Chrome / Chromiumは `settings.json` に保存された実体パスを確認する。Windowsでは直接起動しない
...
- [`docs/research/2026-07-11-external-tool-path-compatibility.md`](../research/2026-07-11-external-tool-path-compatibility.md)
