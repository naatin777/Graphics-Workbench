...
- [0214: 6 target VSIXをネイティブランナーで生成・検証・公開する](0214-native-runner-platform-vsix-release.md) — Done — 5 targetをネイティブランナーで生成しsharpを実実行検証、win32-arm64はcross維持、`--skip-duplicate`とPAT未設定ガード、ADR-0026新設・ADR-0031置き換え
