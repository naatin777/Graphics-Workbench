...
/** Removes abandoned sensitive staging roots from a previous process. */
...
// oxlint-disable-next-line typescript/no-restricted-types -- External manifest values are narrowed at this trust boundary.
