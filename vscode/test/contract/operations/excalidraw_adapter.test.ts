...
import { projectRootDirectory, testInputDirectory } from '../../support/helpers/fixture_paths.js';
...
suite('Excalidraw sceneからSVGを生成する処理', () => {
  ...
  test('実excalidraw-adapter.mjs bundleでbackground-color fixtureをSVGへ変換し、svg・rect要素と正のviewBox・埋め込み@font-faceを含むSVGを生成する', async () => {
    assert.ok(
