...
import type { WebviewHost } from './shared/vscode';
...
} satisfies Record<WebviewPageId, Component<{ host: WebviewHost }>>;
...
export function WebviewApp(properties: { host: WebviewHost }): JSX.Element {
  ...
  return <Page host={properties.host} />;
}
